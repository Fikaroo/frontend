      ...
      <div className="w-full max-w-md space-y-8">
        ...
        <form className="mt-8 space-y-6" action="#" method="POST">
          ...
          <div className="-space-y-px rounded-md shadow-sm">
            ...
            <div>
              ...
              <input
                ...
                autoComplete="email"
                required
                className="relative block w-full px-1 border-0 py-1.5 text-gray-900 ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:z-10 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
          ...
          <p className="flex justify-end text-sm text-gray-500">
            ...
            <Link to="/auth/login" className="pl-1 text-indigo-500">
              Sign In
            </Link>
          </p>
          <div>
